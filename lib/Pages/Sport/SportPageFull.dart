...
import 'package:newsapi/Pages/Sport/SportPageList.dart';
...
class SportPageFull extends StatefulWidget {
  const SportPageFull({Key? key}) : super(key: key);

  @override
  _SportPageFullState createState() => _SportPageFullState();
}

class _SportPageFullState extends State<SportPageFull> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabNewsView = <Widget>[
      const Listfull(sourceNews: GetRss.getRssFrance24Sport),
      const Listfull(sourceNews: GetRss.getRssFranceTvSport),
      const Listfull(sourceNews: GetRss.getRssOuestFrSport),
      const Listfull(sourceNews: GetRss.getRssRmcSport),
    ];

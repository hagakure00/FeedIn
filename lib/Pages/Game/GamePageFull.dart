...
class GamePageFull extends StatefulWidget {
  const GamePageFull({Key? key}) : super(key: key);

  @override
  _GamePageFullState createState() => _GamePageFullState();
}

class _GamePageFullState extends State<GamePageFull> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabNewsView = <Widget>[
      const Listfull(sourceNews: GetRss.getRssGameBlog),
      const Listfull(sourceNews: GetRss.getRssGamergen),
      const Listfull(sourceNews: GetRss.getRssGamekult),
      const Listfull(sourceNews: GetRss.getRssJeuxOnline),
    ];

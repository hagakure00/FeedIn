...
class TechPageFull extends StatefulWidget {
  const TechPageFull({Key? key}) : super(key: key);

  @override
  _TechPageFullState createState() => _TechPageFullState();
}

class _TechPageFullState extends State<TechPageFull> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabNewsView = <Widget>[
      const Listfull(sourceNews: GetRss.getRssNextImpact),
      const Listfull(sourceNews: GetRss.getRssComptHardware),
      const Listfull(sourceNews: GetRss.getRssClubic),
      const Listfull(sourceNews: GetRss.getRssZnet),
    ];
